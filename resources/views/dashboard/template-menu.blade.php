<section class="sidebar h-screen w-[180px] max-[768px]:w-[60px] shadow-2xl">
    ...
    <div class="menu h-full">
        <ul class="flex flex-col h-full lg:pl-4">
            ...
            <a href="{{ url('/logout') }}"><li class="max-[768px]:text-2xl max-[768px]:text-center py-4 mb-16 hover:text-red-500"><i class="fi fi-rr-sign-out-alt "></i><span class="max-[768px]:hidden ml-3">Logout</span></li></a>
        </ul>
    </div>
</section>