    ...
    <section class="content w-full overflow-hidden">
        <div class="title text-xl font-bold mt-2 ml-8 flex justify-between h-[35px]">
            <div class="left-contain flex items-center gap-2">
                <div class="button">
                    <a href="{{ url('order') }}" class="bg-pink-100 px-4 py-2 text-sm rounded-lg font-semibold text-pink-500 hover:bg-pink-500 hover:text-white">Back</a>
                </div>
                <div class="title">
        ...
        <div class="accessibility max-[768px]:h-24 mt-8 flex max-[768px]:flex-col px-8">
            ...
            <div class="buttongroup max-[768px]:w-full w-1/2 flex justify-end max-[768px]:mt-2">
                <a href="{{ url('order/restore') }}" class="add border-2 bg-pink-500 px-4 py-2 text-sm rounded-lg text-white hover:bg-pink-600 text-lg mr-2">Restore All</a>
                {{-- <a href="" class="recycle border-2 border-pink-500 px-4  py-2 text-sm rounded-lg text-pink-500 hover:bg-pink-600 hover:text-white text-lg ml-2">Delete All</a> --}}
