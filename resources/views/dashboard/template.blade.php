    ...
    <section class="sidebar h-screen w-[180px] max-[768px]:w-[60px] shadow-2xl">
        ...
        <div class="menu h-full">
            <ul class="flex flex-col h-full lg:pl-4">
                <a href=""><li class="max-[768px]:text-2xl max-[768px]:text-center py-4 mt-8 hover:text-pink-500"><i class="fi fi-rr-dashboard "></i><span class="max-[768px]:hidden ml-3">Dashboard</span></li></a>
                <a href=""><li class="max-[768px]:text-2xl max-[768px]:text-center py-4 hover:text-pink-500"><i class="fi fi-rr-users "></i><span class="max-[768px]:hidden ml-3">User</span></li></a>
