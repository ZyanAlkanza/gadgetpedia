    ...
    <section class="content w-full overflow-hidden">
        ...
        <div class="accessibility max-[768px]:h-24 mt-8 flex max-[768px]:flex-col px-8">
            ...
            <div class="buttongroup max-[768px]:w-full w-1/2 flex justify-end max-[768px]:mt-2">
                <a href="{{ url('/phone/create') }}" class="add border-2 bg-pink-500 px-4  py-2 text-sm rounded-lg text-white hover:bg-pink-600 text-lg">Add</a>
                <a href="{{ url('/phone/trash') }}" class="recycle border-2 border-pink-500 px-4  py-2 text-sm rounded-lg text-pink-500 hover:bg-pink-600 hover:text-white text-lg ml-2">Recycle</a>
            </div>
        </div>
